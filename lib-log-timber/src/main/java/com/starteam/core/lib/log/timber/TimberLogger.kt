 ...
 *
 */
class TimberLogger(private val timberLogReporterTree: TimberLogReporterTree) : ILogger {
    ...
    override fun setup(debugMode: Boolean) {
        ...
        try {
            if (timberLogReporterTree.logReporters.isNotEmpty()) {
                Timber.plant(timberLogReporterTree)
            }
