package com.starteam.core.lib.network;
...
public final class AppNetworkUtils {
    ...
    public static void openWirelessSettings() {
        AppContextUtils.getApp().startActivity(new Intent(android.provider.Settings.ACTION_WIRELESS_SETTINGS)
    ...
    public static boolean getMobileDataEnabled() {
        try {
            TelephonyManager tm =
                    (TelephonyManager) AppContextUtils.getApp().getSystemService(Context.TELEPHONY_SERVICE);
            if (tm == null) {
                return false;
            }
    ...
    public static boolean getWifiEnabled() {
        ...
        WifiManager manager = (WifiManager) AppContextUtils.getApp().getSystemService(Context.WIFI_SERVICE);
    ...
    public static String getWifiState(){
        if (isWifiConnected()) {
            WifiManager mWifiManager = (WifiManager) AppContextUtils.getApp().getApplicationContext()
