...
public class TCPReadHandler extends ChannelInboundHandlerAdapter {
    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
        Msg message = GsonUtils.fromJson(msg.toString(),Msg.class);
        ...
        if (msgType == imsClient.getServerSentReportMsgType()) {
            ...
            Msg receivedReportMsg = buildReceivedReportMsg(message.getHead().getMsgId());
     ...
     * @return
     */
    private Msg buildReceivedReportMsg(String msgId) throws JSONException {
        if (StringUtil.isNullOrEmpty(msgId)) {
            return null;
        }

        Msg builder = new Msg();
        Head headBuilder = new Head();
