...
public class NettyTcpClient implements IMSClientInterface {
     ...
     */
    @Override
    public void sendMsg(Msg msg, boolean isJoinTimeoutManager) {
        ...
        try {
            channel.writeAndFlush(GsonUtils.toJson(msg));
        } catch (Exception ex) {
        ...
        switch (connectStatus) {
            ...
            case IMSConfig.CONNECT_STATE_SUCCESSFUL: {
                ...
                if (handshakeMsg != null) {
                    System.out.println("发送握手消息，message=" + GsonUtils.toJson(handshakeMsg));
