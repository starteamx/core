...
public final class AppSizeUtils {
    ...
    public static int sp2px(final float spValue) {
        final float fontScale = AppContextUtils.getApp().getResources().getDisplayMetrics().scaledDensity;
        return (int) (spValue * fontScale + 0.5f);
    }
    ...
    public static int dp2px(float dp) {
        final float scale = AppContextUtils.getApp().getResources().getDisplayMetrics().density;
        return (int) (dp * scale + 0.5f);
    }
