...
public final class AppWindowUtils {
    ...
    public static int getScreenWidth() {
        WindowManager wm = (WindowManager) AppContextUtils.getApp().getSystemService(Context.WINDOW_SERVICE);
        if (wm == null) {
            return AppContextUtils.getApp().getResources().getDisplayMetrics().widthPixels;
        }
    ...
    public static int getScreenHeight() {
        WindowManager wm = (WindowManager) AppContextUtils.getApp().getSystemService(Context.WINDOW_SERVICE);
        if (wm == null) {
            return AppContextUtils.getApp().getResources().getDisplayMetrics().heightPixels;
        }
        Point point = new Point();
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR1) {
            wm.getDefaultDisplay().getRealSize(point);
    ...
    public static int getRealScreenHeight(Activity activity) {
        WindowManager windowManager = (WindowManager) AppContextUtils.getApp().getSystemService(Context.WINDOW_SERVICE);
    ...
    public static float getScreenDensity() {
        return AppContextUtils.getApp().getResources().getDisplayMetrics().density;
    }
    ...
    public static int getScreenDensityDpi() {
        return AppContextUtils.getApp().getResources().getDisplayMetrics().densityDpi;
    }
    ...
    public static boolean copyToClipBoard(String content){
        return copyToClipBoard(AppContextUtils.getApp(),content);
    }
