 ...
 *     time  : 2019/12/4
 *     desc  : 专门处理魅族手机，修改状态栏字体颜色的工具类
 *     revise: 参考魅族修改状态栏方案
 *             参考链接：http://open-wiki.flyme.cn/index.php?title=状态栏变色
 * </pre>
 */
public class StatusBarColorUtils {
     ...
     * @param color  颜色
     */
    private static void setStatusBarDarkIcon(Window window, int color) {
        try {
    ...
    public static boolean setStatusBarDarkIcon(Activity activity, boolean dark) {
        return setStatusBarDarkIcon(activity, dark, true);
    }
    ...
    private static boolean setStatusBarDarkIcon(Activity activity, boolean dark, boolean flag) {
