package com.starteam.core.lib.zipfile;
...
public final class AppZipUtils {
    ...
    private static boolean zipFile(final File resFile,
                                   ...
                                   final String comment)
            throws IOException {
        rootPath = rootPath + (AppContextUtils.isSpace(rootPath) ? "" : File.separator) + resFile.getName();
    ...
    public static List<File> unzipFileByKeyword(final File zipFile,
        ...
        if (AppContextUtils.isSpace(keyword)) {
    ...
    private static boolean unzipChildFile(final File destDir,
        ...
        if (entry.isDirectory()) {
            ...
            try {
                ...
                AppContextUtils.closeIO(in, out);
            }
        }
        return true;
    }
