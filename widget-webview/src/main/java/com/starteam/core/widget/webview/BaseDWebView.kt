...
/**
 *     使用方法参考：https://github.com/wendux/DSBridge-Android
 *     author : guanrunbai
 *     time   : 2023/03/06
 *     desc   :
 *     version: 1.0
 *
 */
open class BaseDWebView @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null) :
    DWebView(context, attrs), LifecycleEventObserver {


    private val TAG = "BaseDWebView"
