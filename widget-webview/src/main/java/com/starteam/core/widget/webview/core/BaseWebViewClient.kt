package com.starteam.core.widget.webview.core
...
open class BaseWebViewClient : WebViewClient() {
    ...
    override fun onReceivedSslError(
        ...
        AlertDialog.Builder(view.context).setTitle("提示").setMessage("当前网站安全证书已过期或不可信\n是否继续浏览?")
